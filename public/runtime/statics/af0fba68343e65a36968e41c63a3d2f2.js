...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(y).x(1(){h()});1 h(){2 8=f($(".6-4:w").a("z")+"e")-d A().C();$(".m-l .g-k").v(1(i,o){2 3=f($(o).7(".6-4").a("3")+"e");D(3>0){$(o).7(".6-4").t({3:3,8:8,u:p,s:"<b>%r</b><b>%q</b>:<b>%B</b><b>%H</b>:<b>%P</b><b>%O</b>",Q:1(){2 9=R;2 5=d T();5.E="N";5.n=$(o).7(".6-4").a("n");2 b=$(o);$.G({9:9,F:"I",c:5,J:"L",K:1(c){$(".m-l .g-k").7(".U").M(i).j(c.j)},S:1(o){}})}})}})}',57,57,'|function|var|endtime|nums|query|countdown|find|timespan|url|attr||data|new|000|parseInt|result|init_count_down||html|goods|list|ui|id||10|SM|BM|format|count_down|interval|each|first|ready|document|nowtime|Date|BS|getTime|if|act|type|ajax|SS|POST|dataType|success|json|eq|get_lottery_info_anno|SMS|BMS|callback|AJAX_URL|error|Object|record'.split('|'),0,{}))
