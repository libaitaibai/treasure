...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(l).2u(5(){1q();1i();1P();1E();1C()});5 1E(){4 N=$(".t-g").25().I;N=12(N)-1D;1F(N)}5 1F(y){4 2v=\'2w-2x-Y-2t\';y?y=y:y=1D;$(r).1U(5(){4 s=$(r).1a();c(s>y){$(".t-g").O("t-g-I")}P{$(".t-g").E("t-g-I")}})};5 2o(2p){$.2q("分享成功")}5 1C(){4 b={};b["2y"]=15;b["15"]=15;b["2z"]=\'\';b[\'2G\']=1;b[\'2H\']=1;b["2I"]=$(".2J").19(\'2F\').k(\'2E\');b[\'2A\']=2n;b=2B.2C(b);$("#2D").2K(5(){2a{29.2c(b)}27(e){$.28(e)}})}5 26(){4 w=r.2b||l.1A.1z||l.Z.1z;4 h=r.2j||l.1A.1B||l.Z.1B;4 j={2k:w,2d:h};4 14=1H();1w(4 i 2l 14){j[i]=14[i]}F j}5 1H(){4 C=2e.C;4 j={};c(C.D(/13/i)){4 L=C.D(/13.*/i);j["1M"]="1L=13";j["1I"]=L.D(/([\\d.]+)/)}P c(C.D(/1O/i)){4 L=C.D(/1O.*/i);j["1M"]="1L=2L";j["1I"]=L.D(/([\\d.]+)/)}F j}5 3b(){$(\'#3c\').38({35:\'36\',37:1,3d:1,3k:p,3i:p,3f:V})}5 1P(){4 16=12($(".w-1Q-1j:18").k("3h")+"1m")-T 1x().34();$(".w-1Q-1j").2Q(5(i,o){4 U=12($(o).k("U")+"1m");$(o).2P({U:U,16:16,2O:10,2V:"%H:%M:%S:%32",30:5(){$(o).m("计算中")}})})}5 2W(Q,1b,1o){4 X=T 1x();X.33(X.2X()+1o);l.1v=Q+\'=\'+1b+\';2Z=\'+X}5 31(Q){4 1c=l.1v.1t(\'; \');1w(4 i=0;i<1c.2S;i++){4 17=1c[i].1t(\'=\');c(17[0]==Q){F 17[1]}}F\'\'}5 1q(){$(".A-B").1r(1J,5(){11()});$(".A-B").3e(5(){$(".A-B").39()},5(){$(".A-B").1r(1J,5(){11()})})}5 11(){$(".A-B J").19("u:18").21({3l:"-"+$(".3j J").19("u:18").G()+"2N"},1R,5(){4 u=$(2U);$(".A-B J").1S(\'<u 2Y="n-W">\'+$(u).m()+\'</u>\');$(u).2M()})}4 9=2;4 q=p;4 v=0;5 1i(){$(r).1U(5(){c(v>0&&9>v){q=V;$(".9-1V").m("没有更多夺宝活动了~")}P{$(".9-1V").m("努力加载中...~")}4 x=$(".t-g .g-W a.K").k("1b");4 8=$(".t-g .g-W a.K 3g.3a").k("8");4 24=1X($(r).G())+1X($(r).1a())+1Z;c($(l).G()<=24){c(q==p){q=V;4 7=T 1T();7.9=9;7.x=x;7.8=8;7.23="22";$.1W({1p:1s,R:7,1u:"1n",1l:"1k",1K:5(6){$(".1y-J").1S(6.m);q=p;9++;v=6.9.v}})}}})}5 2g(6){9=2;q=p;v=0;c($(6).1e(\'K\')&&!$(6).1e(\'20\')){F V}$(6).O(\'K\').2f().2h().2i(\'a\').E(\'K\');$("a[1Y=\'2m\']").E(\'f-1d\').E(\'f-1f\');4 1h=$(\'.2r-2s\');1h.1N(\'z-1G\',1Z);$("m,Z").21({1a:$("#2T-I-G").25().I-$(".g-W").G()-3},1R);4 8;c($(6).1e(\'20\')){8=$(6).k(\'8\');4 1g=8==1?0:1;$(6).k(\'8\',1g);c(1g==1){$(6).O(\'f-1d\').E(\'f-1f\')}P{$(6).O(\'f-1f\').E(\'f-1d\')}}4 x=$(6).k("1Y");4 7=T 1T();7.9=1;7.x=x;7.8=8;7.23="22";$.1W({1p:1s,R:7,1u:"1n",1l:"1k",1K:5(R){$(".1y-J").m(R.m);1h.1N(\'z-1G\',-1);9=2;q=p;v=0;1i();$.2R()}})}',62,208,'||||var|function|obj|query|order_dir|page||share_data|if||||nav|||rJson|attr|document|html|||true|stop|window||slider|li|page_total||order|min_height||notice|box|userAgent|match|removeClass|return|height||top|ul|cur|tmp||nav_top_height|addClass|else|name|data||new|endtime|false|item|oDate||body||roll_news|parseInt|Android|rTmp|share_url|timespan|arr2|first|find|scrollTop|value|arr|up|hasClass|down|set_order_dir|loading_list|init_auto_load_data|nums|json|dataType|000|POST|iDay|url|init_notice|everyTime|AJAX_URL|split|type|cookie|for|Date|tuan|clientWidth|documentElement|clientHeight|init_fenxiang|50|init_slide_top|slideNavGoTop|index|IsPC|sdk_version_name|3000|success|dev_type|sdk_type|css|iPhone|init_count_down|countdown|300|append|Object|scroll|load|ajax|parseFloat|sort|100|last|animate|load_index_list_data|act|totalheight|offset|get_brower_info|catch|showErr|App|try|innerWidth|sdk_share|screen_height|navigator|parent|order_sort|siblings|children|innerHeight|screen_width|in|max_buy|title|share_complete|share_key|showSuccess|loading|list|160725071|ready|slide_key_down|FW|XS|share_content|key|share_title|JSON|stringify|fenxiang|src|img|sina_app_api|qq_app_api|share_imageUrl|tempWrap|click|ios|remove|px|interval|count_down|each|refresh_image|length|set|this|format|setCookie|getDate|class|expires|callback|getCookie|MS|setDate|getTime|mode|vertical|displaySlideQty|bxSlider|stopTime|xz|init_adv_slider|marquee|moveSlideQty|hover|controls|span|nowtime|auto|notice_board|captions|marginTop'.split('|'),0,{}))
