...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(g).f(2(){$("#e").d(\'i\',2(){a 1={};1.4=$("#4").k();a 7=/^[\\w\\j-\\l]+$/;6(1.4==""){$.5("用户名不能为空");8 9}b 6(!7.h(1.4)){$.5("您输入的用户名不合法！");8 9}$.m({u:z,y:"n",x:"A",B:1,C:2(3){6(3.v==0){$.5(3.c)}b{$.p(3.c,2(){o.q.r=t})}},s:2(3){$.5("服务器提交失败")}})})});',39,39,'|query|function|da|user_name|showErr|if|name_rul|return|false|var|else|info|bind|chang_user_name|ready|document|test|click|u4e00|val|u9fa5|ajax|json|window|showSuccess|location|href|error|user_center_index_url|url|status||type|dataType|user_change_name_url|post|data|success'.split('|'),0,{}))
