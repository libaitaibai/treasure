...
(function($){
	...
	$.confirm = function(params){
		...
		var markup = [
			...
			'<div id="confirmBox">',
			'<h1>',params.title,'</h1>',
			'<pre style="padding:14px;">',params.message,'</pre>',
...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(s).r(2(){$(".q").7(2(){6 0=$(5).4("0");$.a("您确定收货操作吗？？",2(){$.c({e:0,3:{},9:"8",b:"i",n:2(3){l(3.m==1){j.f.k()}g{h(3.d)}}})})});$(".o").7(2(){6 0=$(5).4("0");$.p({\'t\':\'虚拟商品信息\',\'y\':0,\'z\':{\'确定\':{\'x\':\'w\',\'0\':2(){}}}})});$(".v-u").7(2(){6 0=$(5).4("0");$.a("您确定要关闭订单么？",2(){$.c({e:0,3:{},9:"8",b:"i",n:2(3){l(3.m==1){j.f.k()}g{h(3.d)}}})})})});',36,36,'action||function|data|attr|this|var|click|json|dataType|showConfirm|type|ajax|info|url|location|else|alert|POST|window|reload|if|status|success|fictitious_info|confirm|confirm_receipt|ready|document|title|order|close|gray|class|message|buttons'.split('|'),0,{}))
;
