...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(1f).1e(7(){Z();$("#1g").m("y",7(){19()});K();$(".1n").m("y",7(){a f=$(16).A("f");$.1h("确认要删除？",7(){15(f)})});$("#1k").y(7(){18()})});7 15(f){a o=f;$.P({f:o,N:"M",L:"1c",Q:7(b){g(b.B==1){$.R("删除成功",7(){s.q=b.f})}k{$.O("删除失败")}},H:7(D){}})}7 19(){a U=$("17[d=\'X\']").1i();a o=$("17[d=\'X\']").A("1j");a F=$.T($("V[d=\'F\']").p());a v=$.T($("V[d=\'v\']").p());a 11=/^[1-9][0-9]{5}$/;g(F.W>8){12(\'收件人名字要在8个字以内哦~\');Y 1a}g(v!=""){g(v.W!=6||!11.1l(v)){12(\'请正确填写6个数字的邮编哦~\');Y 1a}}$.P({f:o,N:"M",1r:U,L:"1x",Q:7(b){g(b.B==1){$.R("保存成功",7(){s.q=b.f})}k g(b.B==0){g(b.13){$.O(b.13,7(){g(b.f)s.q=b.f})}k{g(b.f)s.q=b.f}}k{}},H:7(D){}})}7 Z(){$.t=7(j){a d="10"+j;a 1b="10"+(1d(j)+1);a w=$("h[d=\'"+d+"\']").p();g(j==1)a l="E.r"+w+".c";g(j==2)a l="E.r"+$("h[d=\'I\']").p()+".c.r"+w+".c";g(j==3)a l="E.r"+$("h[d=\'I\']").p()+".c.r"+$("h[d=\'14\']").p()+".c.r"+w+".c";g(w==0){a x="<u G=\'0\'>=请选择=</u>"}k{a S=J(l);l+=".";a x="<u G=\'0\'>=请选择=</u>";1q(a C 1o S){x+="<u G=\'"+J(l+C+".i")+"\'>"+J(l+C+".n")+"</u>"}}$("h[d=\'"+1b+"\']").x(x);g(j==4){}k{$.t(1d(j)+1)}};$("h[d=\'I\']").m("z",7(){$.t("1")});$("h[d=\'14\']").m("z",7(){$.t("2")});$("h[d=\'1p\']").m("z",7(){$.t("3")});$("h[d=\'1z\']").m("z",7(){$.t("4")})}7 K(){$(".K").m("y",7(){a o=$(16).A("1w");$.P({f:o,N:"M",L:"1c",Q:7(b){g(b.B==1){$.R("设置成功",7(){s.q=b.f})}k{$.O("设置失败")}},H:7(D){}})})}7 18(){1A{$(\'#1v\').A(\'1u\',1t.s.q)}1y(e){};$(\'.1m\').1s()}',62,99,'|||||||function|||var|obj||name||url|if|select||lv|else|evalStr|bind||ajaxurl|val|href||location|load_select|option|zip|id|html|click|change|attr|status|key|ajaxobj|regionConf|consignee|value|error|region_lv1|eval|set_default|type|json|dataType|showErr|ajax|success|showSuccess|regionConfs|trim|query|input|length|my_address|return|init_region_ui_change|region_lv|zip_rul|alert|info|region_lv2|del_address|this|form|map_show|submit_address|false|next_name|GET|parseInt|ready|document|sub_address|showConfirm|serialize|action|map_select|test|map_select_box|del|in|region_lv3|for|data|show|window|backurl|header_back_btn|dfurl|POST|catch|region_lv4|try'.split('|'),0,{}))
