...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(e).f(1(){9()});1 9(){6 5=b($(".w-2-4:h").c("k")+"8")-l g().m();$(".w-2-4").d(1(i,o){6 3=b($(o).c("3")+"8");$(o).j({3:3,5:5,t:y,n:"%z:%x:%u:%p",q:1(){6 0=$(o).r();$(0).7(".w-2-4").a();$(0).7(".w-2").a();$(0).7(".w-s").v()}})})}',36,36,'parent_obj|function|countdown|endtime|nums|timespan|var|find|000|init_count_down|remove|parseInt|attr|each|document|ready|Date|first||count_down|nowtime|new|getTime|format||MS|callback|parent|countwaiting|interval|S|show||M|10|H'.split('|'),0,{}))
