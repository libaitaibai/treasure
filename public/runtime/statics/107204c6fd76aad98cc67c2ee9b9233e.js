...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(l).k(0(){f()});0 f(){1 7=8($(".w-g-a:z").4("x")+"d")-9 t().A();$(".w-g-a").y(0(i,o){1 3=8($(o).4("3")+"d");1 s=\'v-r-q-j\';$(o).h({3:3,7:7,p:n,m:"<b>%u</b><b>%M</b>:<b>%R</b><b>%Q</b>:<b>%P</b><b>%B</b>",O:0(){1 6=T;1 2=9 V();2.W="U";2.c=$(o).4("c");1 b=$(o);$.S({6:6,N:"F",5:2,E:"D",C:0(5){$(".G H").L(i).K(".J").e(5.e)},I:0(o){}})}})})}',59,59,'function|var|query|endtime|attr|data|url|timespan|parseInt|new|nums||id|000|html|init_count_down|countdown|count_down||160725071|ready|document|format|10||interval|Y|XS|index_time_set|Date|BM|FW||nowtime|each|first|getTime|SMS|success|json|dataType|POST|infoList|li|error|show_content|find|eq|SM|type|callback|BMS|SS|BS|ajax|AJAX_URL|get_lottery_info|Object|act'.split('|'),0,{}))
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('7 s=0;$(U).1D(6(){X();T();N.1C=6(){X()};$(".m-c").e(6(){s=1;$(d).A();$(".G-m-c").H();$(".4-2 a").1B(\'f\');$(".4-2 .r").F(\'f\')});$(".G-m-c").e(6(){s=0;$(d).A();$(".m-c").H();$(".4-2 a").F(\'f\')});$(".1E-c-1F").e(6(){$(d).E(\'f\');$(".4-2 .r").E(\'A\');T()});$(".4-2 a").e(6(){$(d).E(\'f\');$(".4-2 .r").F(\'f\')});$(".Y-c").e(6(){$("#4-2").j("<q t=\'3-u\'>努力加载中...~</q>");$(".4-c-Q").n("w","B")});$(".1g-1I").e(6(){7 R=d;13(6(){7 k=$(R).y("1g-1H-1A");$("#O").g("k",k);7 9=$(R).y(\'9\');$(".4-c-Q").n("w","1J");7 8={k:k,9:9,3:1};$("#4-2").g("8",8);M(8,1m)})});$("#O").e(6(){7 h={},9=$(d).y(\'9\');h[\'1q\']=$(d).g("k");7 v=[];b(s==1){7 D=[];h[\'1y\']=1;b($(".m-1u").n("w")!="B"){$("#4-2").1z("a").1c(6(i){b(!$(d).1d("f")&&!$(d).1d(\'r\'))D.19($.18($(d).j()));h[\'D\']=D.16(",")})}}p{$(".4-2 a.f").1c(6(i){v.19($.18($(d).1t()))});h[\'1G\']=v.1N;h[\'v\']=v.16(\',\')}7 8={};8[\'9\']=9;8[\'h\']=h;1p(8)})});6 X(){7 15=$(N).L();$(".1K").n(\'L\',15)}6 T(){7 1b=$(".4-2").1e();7 1f=U.1a(\'4-2\').1X-U.1a(\'4-2\').1T;7 14=1b-1f;$(".4-2 a").n(\'1e\',14/5-17)}6 1h(){$(".4-2 a").1L("e").e(6(){b($(".m-c").n("w")=="B"){$(".m-c").H();$(".G-m-c").A()}$(d).E(\'f\');$(".4-2 .r").F(\'f\')})}6 13(x){$.K({9:$("#O").y("1V-1Q"),I:"P",10:6(l){b(l.11==0){N.V.W=l.C}p{x()}},12:6(l){$.S("系统错误")}})}6 M(8,x){$.K({1o:"1j",g:{1q:8.k,3:8.3},I:"P",9:8.9,10:6(l){7 j="";7 2=l[\'2\'];1R(7 i 1S 2){b(2[i].1P!=\'0\'){j+=\'<a t="r">\'+2[i].Z+\'</a>\'}p b(s){j+=\'<a t="f">\'+2[i].Z+\'</a>\'}p{j+=\'<a>\'+2[i].Z+\'</a>\'}};b(8.3==1){l.3.3++;$("#4-2").g("3",l.3);$("#4-2").j(j)}p{$("#4-2").1O(j)}1h();b(x){x()}},12:6(){$(".4-c-Q").n("w","B");$.S("系统错误")}})}6 1p(8){7 9=8[\'9\'],h=8[\'h\'];$.K({9:9,g:h,1o:"1j",I:"P",12:6(l){$(".Y-c").1n("e");1M("系统错误")},10:6(o){b(o.11==1||o.11==-1){V.W=o.C}p{$(".Y-c").1n("e");$.S(o.1U,6(){b(o.C){V.W=o.C}})}}})}7 z=1i;6 1m(){7 3=$("#4-2").g("3");b(3.J>1&&3.3<3.J){$("#4-2 a:1k").1l("<q t=\'3-u\'>努力加载中...~</q>")}$("#4-2").1Z(6(){7 1r=1s($(".4-2")[0].1Y)-1s($(".4-2")[0].1W)-20;b($(".4-2").L()>=1r){7 8=$("#4-2").g("8");7 3=$("#4-2").g("3");b(z)1v;b(3.3<=3.J){z=1x;7 8={k:8.k,9:8.9,3:3.3};M(8,6(){$(".3-u").1w();$("#4-2 a:1k").1l("<q t=\'3-u\'>努力加载中...~</q>");z=1i;7 3=$("#4-2").g("3");3.3++;$("#4-2").g("3",3)})}p{$(".3-u").j("已经到底部了...~")}}})}',62,125,'||list|page|number||function|var|config|url|li|if|choose|this|click|active|data|query||html|duobao_item_id|da|all|css|obj|else|div|disable|is_all_select|class|load|choose_number|display|callback|attr|infinite_loading|hide|none|jump|un_choose_number|toggleClass|removeClass|cancel|show|dataType|page_total|ajax|height|ajax_chooose_number|window|confirm|json|box|me|showErr|number_li|document|location|href|resize|close|lottery_sn|success|status|error|check_login|main_list|w_height|join||trim|push|getElementById|w_list|each|hasClass|width|scrollbarWidth|duobao|init_choose_number|false|POST|last|after|init_scroll_bottom|trigger|type|exec_ajax|data_id|totalheight|parseFloat|text|select|return|remove|true|is_all_choose|find|id|addClass|onresize|ready|can|only|buy_num|item|now|block|mask|unbind|alert|length|append|user_id|login|for|in|scrollWidth|info|check|scrollTop|offsetWidth|scrollHeight|scroll|'.split('|'),0,{}))
