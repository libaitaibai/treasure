...
?>
        ...
        <div class="good-on">
            <em class="on">进行中</em>
            <p><?php if ($this->_var['item_data']['is_topspeed']): ?>
            ...
            <span style="color:#df5667; display:block; margin-bottom:.2rem;">1人次=100元&nbsp;&nbsp; <?php if ($this->_var['item_data']['user_max_buy'] > 0): ?>每人限购 <?php echo $this->_var['item_data']['user_max_buy']; ?> 次<?php endif; ?> </span>
            <?php endif; ?>
            <div class="progress">
...
?>);background-size: contain">
                 ...
                 <ul>
                     <li>
                         ...
                         <div class="fl">
                             <a href="<?php
echo parse_url_tag("u:index|anno_user_center|"."lucky_user_id=".$this->_var['item_data']['luck_user_id']."".""); 
?>"><?php echo $this->_var['item_data']['luck_lottery']['user_name']; ?></a>
                     ...
                     <li>
                         <p>本期参与：</p>
                         <span><?php echo $this->_var['item_data']['luck_lottery']['user_total']; ?></span>人次
                     </li>
                     <li>
                     <p>揭晓时间：</p>
                 ...
                 <div class="luckycode">
                     ...
                     <em class="fl"><?php echo $this->_var['item_data']['lottery_sn']; ?></em>
                     <a href="<?php
echo parse_url_tag("u:index|duobao#detail|"."data_id=".$this->_var['item_data']['id']."".""); 
?>">计算详情</a>
                 </div>
...
?>);background-size: contain"></div>
                <div class="txtbox">
                    ...
                    <a href="<?php
echo parse_url_tag("u:index|anno_user_center|"."lucky_user_id=".$this->_var['duobao_order']['user_id']."".""); 
?>"><?php echo $this->_var['duobao_order']['user_name']; ?></a>
                    <!-- <a href="<?php
