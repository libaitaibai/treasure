...
<div class="header">
	...
	<div class="c-hd" style="background:#d93a55;color:#fff">
        <section class="cut_city">
              <a id="header_back_btn" backurl='-1'><i class="iconfont" style="color: #fff">&#xe60b;</i></a>
	    </section>
        <section class="logo_img"><?php echo $this->_var['data']['page_title']; ?></section>
        <section class="cut_city hd-right"></section>
     </div>
	 </div>
</div>	
<?php endif; ?>
