...
?>" class="goods-title" title="<?php echo $this->_var['cart_item_group']['name']; ?>">
                    ...
                    <div class="btn-box">
                        <a class="duobao-now btn" buy_num="<?php echo $this->_var['cart_item_group']['min_buy']; ?>" data_id="<?php echo $this->_var['cart_item_group']['id']; ?>" onclick="add_cart(this,1)">立即购买</a>
                    </div>
                </div>
                <?php else: ?>
    ...
    <div class="duobao-rule f_r">
        <h1 class="title">百元专区 规则说明</h1>
        <div class="ten-rule-wrap">
        <ul class="ten-rule">
            <li><span>1.</span>每参与1人次需花费100元;</li>
            <li><span>2.</span>每参与1人次，系统将会随机分配一个您的专属云号码；</li>
            <li><span>3.</span>幸运码计算规则采用第三方时时彩数据、公平、公正、透明.</li>
        </ul>
        </div>
    </div>
</div>
