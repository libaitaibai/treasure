	...
	<div class="goods-detail-buy f_r">
		...
		<div class="detail-buy-info" style="display: block;">
			...
			<div class="buy-info-header clearfix">
				...
				<h2 class="info-header-title"><?php if ($this->_var['root']['item_data']['unit_price'] == 100): ?>百<?php elseif ($this->_var['root']['item_data']['min_buy'] == 10): ?>十<?php else: ?>一<?php endif; ?>元夺宝</h2>
				...
				<div class="buy-explain">
					...
					<div class="explain-box">
						...
						<div class="explain-content">
							<p>“一元夺宝”指用户花费1元兑换一个夺宝币，随后可凭夺宝币使用一元夺宝的服务。</p>
