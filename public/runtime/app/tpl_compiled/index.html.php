	...
	<div style="" class="index_float_bottom">
		...
		<div class="index_float_bottom_in">
			...
			<div class="index_float_wx">
				...
				<img src="./app/app.png" style="margin-left:10px">
			</div>
		</div>
	</div>
 	<!--E 底层悬浮 -->	
...
?>"><?php echo $this->_var['lastet']['user_name']; ?></a></p>
										<p>本期参与：<?php echo $this->_var['lastet']['luck_user_buy_count']; ?>人次</p>
										<p>幸运号码：<?php echo $this->_var['lastet']['lottery_sn']; ?></p>
									</div>
...
?>" class="user_name f_l" title="<?php echo $this->_var['newest_lottery']['user_name']; ?>(ID:<?php echo $this->_var['newest_lottery']['luck_user_id']; ?>)"><?php echo $this->_var['newest_lottery']['user_name']; ?></a><sapn class="duobao-time f_r">于<?php echo $this->_var['newest_lottery']['span_time']; ?></sapn>
									</div>
...
<div class="wrap_full_w">
	<?php if ($this->_var['cate_list_product']): ?>
		<?php $_from = $this->_var['cate_list_product']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cate_list_0_49870600_1551064651');if (count($_from)):
    foreach ($_from AS $this->_var['cate_list_0_49870600_1551064651']):
?>
		 <?php if ($this->_var['cate_list_0_49870600_1551064651']['duobao_list']): ?>
		<div class="index-goods-list" style="width: 1201px">
			<h1 class="main-title"><?php echo $this->_var['cate_list_0_49870600_1551064651']['name']; ?>
			<a href="<?php
...
?>" class="title-more">更多商品，点击查看>></a>
			...
			<a href="<?php
echo parse_url_tag("u:index|duobaos|"."id=".$this->_var['cate_list']['id']."".""); 
?>" class="title-more"><img src="<?php echo $this->_var['cate_list_0_49870600_1551064651']['image']; ?>" width="238" height="400"  ></a>
			<!-- <?php echo show_adv("cate_banner","","238","400");  ?> -->
			</li>
			<?php $_from = $this->_var['cate_list_0_49870600_1551064651']['duobao_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot_duobao');if (count($_from)):
    foreach ($_from AS $this->_var['hot_duobao']):
?>
				<li class="goods ui-item">
				<div class="hover_line">
