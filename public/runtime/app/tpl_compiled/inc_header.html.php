...
?>
	...
	<div class="cart_tip_margin f_r">
		<a href="javascript:void(0);" class="cart_tip"><i class="ico ico-mini-cart"></i><span class="cart_title">清单</span><div class="cart-count-wrap"><i class="ico ico-white-solid ico-white-solid-l"></i><b class="cart_count"><?php echo $this->_var['cart_info']['cart_item_num']; ?></b></div>
		</a>
	</div>
