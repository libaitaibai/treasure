...
?>" class="goods-title" title="<?php echo $this->_var['cart_item_group']['name']; ?>">
                        ...
                        <div class="btn-box">
                            <a class="duobao-now btn" buy_num="<?php echo $this->_var['cart_item_group']['min_buy']; ?>" data_id="<?php echo $this->_var['cart_item_group']['id']; ?>" onclick="add_cart(this,1)">免费云购</a>
                        </div>
                    </div>
                    <?php else: ?>
    ...
    <div class="duobao-rule f_r">
        <h1 class="title">免费购 规则说明</h1>
        <div class="ten-rule-wrap">
            <ul class="ten-rule">
            	<li><span>1.</span>“新注册用户”才能购买。</li>
                <li><span>2.</span> 只能用优惠币进行夺宝;</li>
                <li><span>3.</span>“上传头像”即可获得优惠币;</li>
                <li><span>4.</span>“邀请好友”每推荐一位好友注册可获优惠币。</li>
            </ul>
        </div>
    </div>
</div>
