...
return array(
			...
			"Bills"	=>	array(
					...
					"node"	=>	array(
							...
							"uc_money"=>array("name"=>"充值记录","module"=>"uc_money","action"=>"incharge"),
					        "uc_money_cash"=>array("name"=>"提现记录","module"=>"uc_money_cash","action"=>"withdraw"),
							"uc_consignee"=>array("name"=>"配送地址","module"=>"uc_consignee","action"=>"index"),		
					        "uc_fx"=>array("name"=>"我的邀请","module"=>"uc_fx","action"=>"index"),
