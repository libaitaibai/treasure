...
class newsModule extends MainBaseModule
{
    ...
    {       
        ...
        if(!$is_agreement){
            //输出文章
            $content = $GLOBALS['db']->getRow("select title,content from ".DB_PREFIX."web_article where is_effect = 1 and id=".$web_article_id." ");
    ...
    public function laws(){
        ...
        $GLOBALS['tmpl']->display("laws.html");
